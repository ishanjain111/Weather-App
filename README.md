This is a weather application, which can be used to check the real-time temperature condition of a city using its name. User also get to know about the Latitude and Longitude of the city.
